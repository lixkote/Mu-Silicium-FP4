...
class CommonPlatform ():
    PackagesSupported = ("FP4Pkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('FP4', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "FP4", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "FP4Pkg/FP4.dsc", "Platform Hardcoded")
